...
---
Esse é um projeto de aprendizado React.js com gerenciamento de estado em Redux, cujo objetivo é construir uma carteira digital que registra despesas e converte o valor de diferentes moedas para BRL.
...
1. Clone o repositório
  * `git clone git@github.com:MikaelaBraga/trybe-wallet`.
